...
const BUNDLES = {
  base: {
    ...
    features: [
      ...
      { text: "Generated by leading AI technology", included: false },
  ...
  ultimate: {
    ...
    features: [
      ...
      { text: "1 compatibility analysis", included: true },
      { text: "Transit updates covering 3 months", included: true },
    ],
  },
};
      ...
      {/* Bundle Selection */}
        <div className="mb-12 mt-6">
          <h2 className="font-serif text-3xl font-semibold gold-gradient-text text-center mb-10">
            ...
            <span className="block text-xl mt-1 font-normal">Select Base and choose your specific add ons</span>
          </h2>
